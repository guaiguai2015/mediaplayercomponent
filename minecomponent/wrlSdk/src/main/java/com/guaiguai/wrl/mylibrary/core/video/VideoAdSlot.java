package com.guaiguai.wrl.mylibrary.core.video;
...
import com.guaiguai.wrl.mylibrary.module.AdValue;
import com.guaiguai.wrl.mylibrary.report.ReportManager;
import com.guaiguai.wrl.mylibrary.widget.CustomVideoView;
import com.guaiguai.wrl.mylibrary.widget.VideoFullDialog;
...
public class VideoAdSlot implements CustomVideoView.ADVideoPlayerListener {
    ...
    public VideoAdSlot (AdValue adInstance,
                        AdSDKSlotListener slotListener,
    ...
    public void onClickVideo() {
        ...
        if (mSlotListener != null) {
            if (mVideoView.isFrameHidden() && !TextUtils.isEmpty(desationUrl)) {
                ...
                try {
                    ReportManager.pauseVideoReport(mXAdInstance.clickMonitor,
